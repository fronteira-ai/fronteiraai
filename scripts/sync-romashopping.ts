/**
 * Sincronização completa do conector Roma Shopping.
 *
 * Uso:
 *   npm run sync:romashopping               # dry-run (padrão)
 *   npm run sync:romashopping -- --execute  # grava no banco
 */

import { RomaShoppingConnector } from "../src/domains/connectors/crawler/romashopping/connector";
...
async function main() {
  console.log("╔══════════════════════════════════════════════╗");
  console.log("║   Roma Shopping Connector — Sync             ║");
  console.log("╠══════════════════════════════════════════════╣");
  console.log(`║  Modo   : ${dryRun ? "DRY-RUN (sem gravar)         " : "EXECUÇÃO REAL                "} ║`);
  console.log("╚══════════════════════════════════════════════╝\n");

  const connector = new RomaShoppingConnector();
  console.log(`[Fetch] Buscando produtos em romapy.com...`);
