      ...
      <div className="mx-auto max-w-6xl">
        <Reveal direction="up">
          <div className="text-center mb-14">
            <span className="inline-block rounded-full border border-emerald-500/30 bg-emerald-500/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[2px] text-emerald-400 mb-5">
              Para Lojistas
            </span>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 mb-12">
          {benefits.map((b, i) => (
            <Reveal key={b.title} direction="up" delay={i * 60}>
              <div className="group rounded-2xl border border-slate-800 bg-slate-900/50 p-6 transition-all duration-300 hover:border-emerald-500/30 hover:bg-slate-900">
        ...
        <Reveal direction="up">
          <div className="rounded-2xl border border-emerald-500/20 bg-gradient-to-br from-emerald-950/60 via-slate-900/80 to-slate-950 p-8 sm:p-10 flex flex-col sm:flex-row items-center gap-8">
