...
export default function GradientCard({ children, className = "" }: Props) {
  return (
    <div
      className={`relative overflow-hidden rounded-3xl border border-blue-500/20 bg-gradient-to-br from-blue-950/60 via-slate-900/80 to-slate-950 p-7 sm:p-10 ${className}`}
    >
